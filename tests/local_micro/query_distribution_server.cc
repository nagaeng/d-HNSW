...
// DEFINE_string(dataset_path, "../datasets/text10M/text10M.fvecs", "Path to the dataset.");
using grpc::Server;
...
int main(int argc, char** argv) {
    ...
    DistributedHnsw dhnsw(dim, num_sub_hnsw, meta_hnsw_neighbors, sub_hnsw_neighbors, num_meta, Angular);
    ...
    std::vector<uint8_t> serialized_data = dhnsw.serialize_with_record_with_gap(offset_sub_hnsw);
    ...
    std::string server_address = "130.127.134.68:" + std::to_string(FLAGS_port);
